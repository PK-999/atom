  ...
  return (
    <AppShell>
      <article className="foundation">
        ...
        <p>
          Evidence remains unpublished until it has passed source,
          comparability, licensing, and editorial review. Missing or
          incompatible evidence is shown explicitly rather than replaced with an
          invented value.
        </p>
        <p className="status">
