...
> = {
  ...
  "lifecycle-ghg": {
    ...
    explanations: {
      beginner:
        "Some ways of making electricity release much more climate pollution than others, even after we count building them.",
      explorer:
  ...
  "land-use": {
    ...
    explanations: {
      beginner:
        "Some power plants need huge fields, while others make lots of clean electricity in a small space.",
      explorer:
  ...
  "water-withdrawal": {
    ...
    explanations: {
      beginner:
        "Power plants take in water from rivers or oceans to stay cool while working.",
      explorer:
  ...
  "water-consumption": {
    ...
    explanations: {
      beginner:
        "Some power plants turn water into steam that floats away into the sky.",
      explorer:
  ...
  "material-requirements": {
    ...
    explanations: {
      beginner:
        "Building different power plants takes lots of concrete, steel, glass, and copper.",
      explorer:
  ...
  "mining-intensity": {
    ...
    explanations: {
      beginner:
        "Making electricity requires digging rocks and minerals out of the ground.",
      explorer:
  ...
  "waste-volume": {
    ...
    explanations: {
      beginner:
        "Every power plant leaves behind some leftover materials when making energy.",
      explorer:
  ...
  "waste-persistence": {
    ...
    explanations: {
      beginner:
        "Some leftovers stay dangerous for hundreds of years, while some chemicals stay dangerous forever.",
      explorer:
  ...
  "capacity-factor": {
    ...
    explanations: {
      beginner:
        "Some power plants can run all day and night, while others only make power when the sun shines or the wind blows.",
      explorer:
  ...
  dispatchability: {
    ...
    explanations: {
      beginner:
        "Can grid operators turn this power plant on whenever homes and factories need electricity?",
      explorer:
  ...
  variability: {
    ...
    explanations: {
      beginner:
        "The wind changes speed and clouds cover the sun, so clean energy output goes up and down.",
      explorer:
  ...
  "firm-capacity": {
    ...
    explanations: {
      beginner:
        "How much power can we count on during the hottest or coldest days of the year?",
      explorer:
  ...
  "storage-dependence": {
    ...
    explanations: {
      beginner:
        "If we use only the sun and wind, we need giant batteries to store power for calm, cloudy weeks.",
      explorer:
  ...
  "capital-cost": {
    ...
    explanations: {
      beginner:
        "How much money does it take to buy the land, equipment, and build the entire power plant before it starts?",
      explorer:
  ...
  "operating-cost": {
    ...
    explanations: {
      beginner:
        "How much does it cost every year to pay the workers and keep the plant running smoothly?",
      explorer:
  ...
  "fuel-cost": {
    ...
    explanations: {
      beginner: "How much does the fuel cost to make each unit of electricity?",
      explorer:
  ...
  lcoe: {
    ...
    explanations: {
      beginner:
        "If you divide all the money spent on a plant over its whole life by all the power it ever makes, what is the price?",
      explorer:
  ...
  "construction-duration": {
    ...
    explanations: {
      beginner:
        "How many years does it take from breaking ground until the power plant starts making electricity?",
      explorer:
  ...
  "plant-lifetime": {
    ...
    explanations: {
      beginner:
        "How many years can the power plant keep working before it has to be retired?",
      explorer:
  ...
  "decommissioning-cost": {
    ...
    explanations: {
      beginner:
        "How much does it cost to safely tear down the plant and clean up the land when it gets retired?",
      explorer:
  ...
  "financing-sensitivity": {
    ...
    explanations: {
      beginner:
        "If bank interest rates go up, which power plants become much more expensive to build?",
      explorer:
  ...
  mortality: {
    ...
    explanations: {
      beginner:
        "Which energy sources are safest for human health, and which ones cause harmful air pollution?",
      explorer:
  ...
  "air-pollution": {
    ...
    explanations: {
      beginner:
        "Burning fossil fuels releases dirty smoke that makes people sick, but clean power does not make smoke.",
      explorer:
  ...
  "occupational-hazard": {
    ...
    explanations: {
      beginner:
        "How safe is it for technicians, miners, and engineers to do their jobs at the power plant?",
      explorer:
  ...
  "accident-risk": {
    ...
    explanations: {
      beginner:
        "What happens when something goes terribly wrong at a big power plant or dam?",
      explorer:
  ...
  displacement: {
    ...
    explanations: {
      beginner:
        "Do people have to pack up their homes and move away to build a reservoir or because of an accident?",
      explorer:
  ...
  "fuel-energy-density": {
    ...
    explanations: {
      beginner:
        "A single tiny uranium pellet makes as much electricity as three giant train cars of coal!",
      explorer:
  ...
  "stockpiling-potential": {
    ...
    explanations: {
      beginner:
        "How easy is it to keep years of spare fuel stored safely at the power plant in case of an emergency?",
      explorer:
  ...
  "import-dependence": {
    ...
    explanations: {
      beginner:
        "Does a country have to buy energy fuel from other nations, or can it make power at home?",
      explorer:
  ...
  "supply-chain-concentration": {
    ...
    explanations: {
      beginner:
        "Are the special parts and metals to build the plant made all over the world, or does one country control them all?",
      explorer:
  ...
  "power-density": {
    ...
    explanations: {
      beginner:
        "How much electricity can we make inside a single square meter of space?",
      explorer:
  ...
  "thermal-efficiency": {
    ...
    explanations: {
      beginner:
        "How much of the hot heat created by the plant actually turns into useful electricity?",
      explorer:
  ...
  "refueling-cycle": {
    ...
    explanations: {
      beginner:
        "How long can the reactor make electricity before workers need to stop and put in fresh fuel?",
      explorer:
  ...
  "typical-capacity": {
    ...
    explanations: {
      beginner: "How big is one single turbine, panel, or nuclear reactor?",
      explorer:
